...
interface CardProps {
  ...
  const Card: React.FC<CardProps> = ({ title, description, iconSrc, backgroundImage }) => {
    return (
      <div 
  ...
  const cards: CardProps[] = [
    {
      ...
      description: "Mentioning number of hours for online classes • Class duration (online): 4 hours",
    ...
    {
      title: "SOP Writing",
      description: "SOP writing practices, mentorship, guidance, and step-by-step techniques to ensure cohesiveness, accuracy, and efficiency in SOP execution. Thrice every month",
    ...
    },
    {
      ...
      description: "Proper mock analysis involves identifying mistakes, weak areas, and patterns. Discussions clarify doubts, offer new insights, and boost conceptual understanding for better performance.",
      backgroundImage: "/benefitcolor5.png"
    },
    {
      title: "Premium Faculties",
      description: "Premium faculties with over a decade of teaching experience bring deep subject knowledge, effective teaching methodologies, valuable query resolution and trustable resources.",
    ...
    />
        ...
        <div className="mt-12 mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* First support card */}
            <div className="flex items-center p-4 rounded-lg shadow-lg h-full bg-black">
              <div className="text-white mr-3">
                <img src="/telegram.png" alt="Telegram" className="w-8 h-8" />
              </div>
              <div className="flex flex-col">
                <h3 className="text-blue-600 font-bold">Telegram support 24×7</h3>
              </div>
            </div>
            
            {/* Second support card */}
            <div className="flex items-center p-4 rounded-lg shadow-lg h-full" style={{ backgroundColor: "#1a8e2d" }}>
             
              <div className="flex flex-col">
                <h3 className="text-white font-bold">Dedicated LMS system with score and progress tracking</h3>
              </div>
            </div>
            
            {/* Third support card */}
            <div className="flex items-center p-4 rounded-lg shadow-lg h-full" style={{ backgroundColor: "#0084ff" }}>
              
              <div className="flex flex-col">
                <h3 className="text-white font-bold">Offline support available upon request</h3>
              </div>
            </div>
          </div>
        </div>
